...
interface ReviewAttendanceCorrectionProps {
  onCreated: () => void;
}

export default function ReviewAttendanceCorrection({
  onCreated,
}: ReviewAttendanceCorrectionProps) {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus(CorrectionRequestStatus.IN_REVIEW)
      onCreated();
    } finally {
      setLoading(false);
    }
