...
export function CreateDepartmentForm({ onSuccess, onCancel }: CreateDepartmentFormProps) {
  ...
  // Note: We only show active departments in the UI, but inactive department codes can be reused
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const dataToSend: CreateDepartmentDto = {
