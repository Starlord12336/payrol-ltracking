...
import { ShiftDTO } from '../dtos/shiftListItemDTO.dto';
...
export class TimeManagementController {
  ...
  /*@ApiBearerAuth('access_token') @Roles(SystemRole.HR_ADMIN, SystemRole.SYSTEM_ADMIN) @UseGuards(AuthGuard, JwtAuthGuard)
  ...
  async updateShiftAssignmentByEmployee(
    @Param('id') id: string,
    @Body() data: UpdateShiftAssignmentDtoEmployee,
  ): Promise<ShiftAssignmentDocument[]> {
    return await this.timeManagementService.updateShiftAssignmentByEmployee(
      id,
      data,
    );
  }
  ...
  async updateShiftAssignmentByPosition(
    @Param('id') id: string,
    @Body() data: UpdateShiftAssignmentDtoPosition,
  ): Promise<ShiftAssignmentDocument[]> {
    return await this.timeManagementService.updateShiftAssignmentByPosition(
      id,
      data,
    );
  }
  ...
  async updateShiftAssignmentByDepartment(
    @Param('id') id: string,
    @Body() data: UpdateShiftAssignmentDtoDepartment,
  ): Promise<ShiftAssignmentDocument[]> {
    return await this.timeManagementService.updateShiftAssignmentByDepartment(
      id,
      data,
    );
  }
  ...
  async deleteShiftAssignmentByDepartment(
    ...
    return await this.timeManagementService.deleteShiftAssignmentByDepartment(
      id,
    );
  }
  ...
  async createShiftAssignmentByEmployee(
    @Body() dto: CreateShiftAssignmentDtoEmployee,
  ): Promise<ShiftAssignmentDocument> {
    const newShiftAssignment =
      await this.timeManagementService.createShiftAssignmentByEmployee(dto);
  ...
  async createShiftAssignmentByPosition(
    @Body() dto: CreateShiftAssignmentDtoPosition,
  ): Promise<ShiftAssignmentDocument> {
    const newShiftAssignment =
      await this.timeManagementService.createShiftAssignmentByPosition(dto);
    return newShiftAssignment;
  }
  ...
  async createShiftAssignmentByDepartment(
    @Body() dto: CreateShiftAssignmentDtoDepartment,
  ): Promise<ShiftAssignmentDocument> {
    const newShiftAssignment =
      await this.timeManagementService.createShiftAssignmentByDepartment(dto);
    return newShiftAssignment;
  }
  ...
  async updateOvertimeRule(
    @Param('id') id: string,
    @Body() data: UpdateOvertimeRuleDto,
  ): Promise<OvertimeRuleDocument> {
  ...
  async createOvertimeRule(
    @Body() data: CreateOvertimeRuleDto,
  ): Promise<OvertimeRuleDocument> {
  ...
  async updateAttendance(
    @Param('id') id: string,
    @Body() data: UpdateAttendanceRecordDto,
  ): Promise<AttendanceRecordDocument> {
  ...
  async createAttendance(
    @Body() data: CreateAttendanceRecordDto,
  ): Promise<AttendanceRecordDocument> {
  ...
  async updateLateness(
    @Param('id') id: string,
    @Body() data: UpdateLatenessRuleDto,
  ...
  async createLateness(
    @Body() data: CreateLatenessRuleDto,
  ): Promise<LatenessRuleDocument> {
  ...
  async updateTimeException(
    @Param('id') id: string,
    @Body() data: UpdateTimeExceptionDto,
  ): Promise<TimeExceptionDocument> {
  ...
  async createTimeException(
    @Body() data: CreateTimeExceptionDto,
  ): Promise<TimeExceptionDocument> {
  ...
  @UseGuards(AuthGuard, JwtAuthGuard)
  @Roles(SystemRole.HR_MANAGER)
  @Put('attendanceCorrection/:id')
  async updateAttendanceCorrection(
    @Param('id') id: string,
    @Body() data: UpdateAttendanceCorrectionRequestDto,
  ): Promise<AttendanceCorrectionRequestDocument> {
    return await this.timeManagementService.updateAttendanceCorrection(
      id,
      data,
    );
  }
  ...
  @UseGuards(AuthGuard, JwtAuthGuard)
  @Roles(SystemRole.HR_MANAGER)
  @Post('attendanceCorrection')
  async createAttendanceCorrection(
    @Body() data: CreateAttendanceCorrectionRequestDto,
  ): Promise<AttendanceCorrectionRequestDocument> {
  ...
  @UseGuards(AuthGuard, JwtAuthGuard)
  @Roles(SystemRole.HR_MANAGER)
  @Delete('attendanceCorrection/:id')
  ...
  async submitAttendanceCorrection(
    ...
    return await this.timeManagementService.submitAttendanceCorrection(
      employeeId,
      data,
    );
  }
