...
import {CreateShiftDto, CreateShiftTypeDto, UpdateShiftDto, UpdateShiftTypeDto} from '../dtos/shift.dto';
...
import {CreateScheduleRuleDto, UpdateScheduleRuleDto} from '../dtos/schedule.dto';
...
import {CreateOvertimeRuleDto, UpdateOvertimeRuleDto} from '../dtos/rules.dto';
...
export class TimeManagementController {
    ...
    @ApiBearerAuth('access_token') @Roles(SystemRole.HR_ADMIN, SystemRole.SYSTEM_ADMIN) @Roles(SystemRole.HR_MANAGER) @UseGuards(AuthGuard, JwtAuthGuard)
    @Get('schedule')
    ...
    @ApiBearerAuth('access_token') @Roles(SystemRole.HR_ADMIN, SystemRole.SYSTEM_ADMIN) @Roles(SystemRole.HR_MANAGER, SystemRole.PAYROLL_SPECIALIST, SystemRole.DEPARTMENT_HEAD) @UseGuards(AuthGuard, JwtAuthGuard)
    @Get('/overtime')
    ...
    @ApiBearerAuth('access_token') @Roles(SystemRole.HR_ADMIN, SystemRole.SYSTEM_ADMIN) @Roles(SystemRole.HR_MANAGER, SystemRole.PAYROLL_SPECIALIST) @UseGuards(AuthGuard, JwtAuthGuard)
    @Put('overtime/:id')
    ...
    @ApiBearerAuth('access_token') @UseGuards(AuthGuard, JwtAuthGuard)
    @Post('lateness')
    ...
    @ApiBearerAuth('access_token') @UseGuards(AuthGuard)
